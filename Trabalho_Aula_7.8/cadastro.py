...
def login():
    ...
    titll = Label(frlogin, text='LOGIN', font='Arial 36', background=colorbg2, foreground='white')
    titll.grid(row=1, column=1)

    user = Label(frlogin, text=' Usuário:', font='Arial 25', foreground=cletra, background=colorbg2)
    user.grid(row=3, column=1, pady=20)
    ...
    sh = Entry(frlogin, show='*', foreground=cletra, background=colorbg1,borderwidth=3)
...
m = Radiobutton(frdados, text='Masculino', variable=radioVale, value=1, background=colorbg2, foreground='#BDB76B',
                borderwidth=3)
m.grid(row=3, column=2)
f = Radiobutton(frdados, text='Feminino',  value=2, variable=radioVale, background=colorbg2, fg='#BDB76B',
                borderwidth=3)
